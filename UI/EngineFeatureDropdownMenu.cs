...
{
    /// <summary>
    /// Dropdown menu for engine feature selection modes
    /// </summary>
    public class EngineFeatureDropdownMenu : MonoBehaviour
    {
        private GameObject menuPanel;
        private EngineFeatureMode currentMode = EngineFeatureMode.Best;
        private System.Action<EngineFeatureMode> onModeSelected;
        ...
        private void CreateDropdownMenu()
        {
            ...
            menuPanel = new GameObject("EngineFeatureDropdownPanel");
            ...
            rect.sizeDelta = new Vector2(180f, 85f);
            ...
            // Create menu items
            CreateMenuItem("✓ Best (Expensive)", EngineFeatureMode.Best, 0);
            CreateMenuItem("  Cheapest", EngineFeatureMode.Cheapest, 1);
        }

        private void CreateMenuItem(string label, EngineFeatureMode mode, int index)
        {
            ...
            colors.highlightedColor = new Color(0.4f, 0.5f, 0.6f, 0.8f); // Blueish for engine
            colors.pressedColor = new Color(0.3f, 0.4f, 0.5f, 1f);
        ...
        private void SelectMode(EngineFeatureMode mode)
        {
            currentMode = mode;
            ...
            for (int i = 0; i < menuPanel.transform.childCount; i++)
            {
                ...
                if (textObj != null)
                {
                    ...
                    if (text != null)
                    {
                        ...
                        if (System.Enum.TryParse<EngineFeatureMode>(modeName, out var mode))
                        {
        ...
        private string GetModeLabel(EngineFeatureMode mode)
        {
            return mode switch
            {
